        ...
        if (currentRace) {
          ...
          for (const existingResult of existingResultsForPigeon) {
            ...
            if (existingRace && 
              ...
              console.log(`Skipping duplicate result for ring ${result.ring_number} in race "${currentRace.race_name}" on date ${currentRace.date} - pigeon already has result for this exact race and date`);
              break;
            }
          }
